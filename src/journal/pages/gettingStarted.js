...
function gettingStartedBodyHTML({ prefix }) {
  ...
  // Build HTML with plain string concatenation to avoid any template literal parsing issues.
  let html = '';
  ...
  // Real clickable Settings link (wired to main.js bindOpenSettings via data-lazy-open-settings)
  html += '<p><a href="#" class="lgmp-open-settings" data-lazy-open;
