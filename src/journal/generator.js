...
import { ensureFolder, nextSequenceNumber, findPreviousSession, getPreviousSectionHTML } from './helpers.js';
  ...
  for (const def of PAGE_ORDER) {
    ...
    switch (def.key) {
      ...
      case 'review-characters':
        pages.push(createReviewCharactersPage(def, prevContent));
        break;
      case 'important-npcs':
        pages.push(createImportantNpcsPage(def, prevContent));
        break;
      default:
